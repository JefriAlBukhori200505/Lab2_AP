...
int main() {
    int angka; // variabel angka untuk menyimpan input
    cout << "Masukkan sebuah bilangan bulat: ";
    cin >> angka;

    if (angka % 10 == 0) { // Pemeriksaan apakah angka adalah kelipatan dari 10
        cout << angka << " adalah kelipatan dari 10." << endl;
    } else if (angka % 5 == 0) { // Jika bukan kelipatan 10, periksa apakah kelipatan 5
 ...
 return 0; // mengembalikan nilai 0 sebagai tanda selesai
}
